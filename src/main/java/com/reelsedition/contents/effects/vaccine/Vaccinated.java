...
public class Vaccinated {
    ...
    private static final String TAG = "reelsedition_vaccine";
    ...
    public static void onJoin(EntityJoinWorldEvent e) {
        if (e.getEntity() instanceof EntityPlayer && !e.getWorld().isRemote) {
            ...
            if (p.getEntityData().getBoolean(TAG) && p.getActivePotionEffect(VaccinatedEffect.INSTANCE) == null) {
                PotionEffect eff = new PotionEffect(VaccinatedEffect.INSTANCE, 32767, 0, false, false);
