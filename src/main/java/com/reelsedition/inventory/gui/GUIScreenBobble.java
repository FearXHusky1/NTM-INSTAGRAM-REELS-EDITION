package com.reelsedition.inventory.gui;
...
public class GUIScreenBobble extends GuiScreen {
    ...
    private final BlockBobbleAddon.TileEntityBobble bobble;

    public GUIScreenBobble(BlockBobbleAddon.TileEntityBobble bobble) {
        this.bobble = bobble;
    }
